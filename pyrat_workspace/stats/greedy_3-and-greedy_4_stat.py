...
if __name__ == "__main__":
    ...
    for program in PROGRAMS:
        print("Program", program.__name__, "requires on average", numpy.mean(results[program.__name__]["turns"]), 
        "actions, with an average preprocessing duration of", numpy.mean(results[program.__name__]["preprocessing_duration"]), 
        "seconds, and an average turn duration of", numpy.mean(results[program.__name__]["turn_durations"]), "seconds")
