...
def tsp ( complete_graph: Dict[int, Dict[int, Union[None, int]]],
    ...
    def _tsp (complete_graph, current_vertex, length_current_route, current_route):
        ...
        # If there are still vertices to visit, we explore unexplored neighbours
        for neighbour in complete_graph[current_vertex] :
            if neighbour not in current_route :
                _tsp(complete_graph, neighbour, length_current_route + complete_graph[current_vertex][neighbour], current_route + [neighbour])
